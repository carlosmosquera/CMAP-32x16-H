...
public class RingMeshGeneratorMain : MonoBehaviour
{
    private float innerRadius = 2.98f;
    private float outerRadius = 3.02f; // Increased outer radius for a thicker ring
    private int segments = 144; // Increased segment count for smoother edges and a more solid look
